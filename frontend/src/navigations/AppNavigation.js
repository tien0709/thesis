...
import VoiceDeviceScreen from  '../screens/VoiceDevice/VoiceDeviceScreen';
import MLScreen from  '../screens/MachineLearning/MachineLearningScreen';
...
function MainNavigator() {
  return(
    ...
    <Stack.Screen name='VoiceDevice' component={VoiceDeviceScreen}
        options={{
          headerShown: false,
          headerTitle: '',
        }}
