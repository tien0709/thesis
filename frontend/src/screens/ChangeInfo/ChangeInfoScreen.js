...
export default function ChangeInfoScreen(props) {
  ...
  const fetchData = async () => {
    try {
      const fetchedAccount = await updateAccount(email, newEmail.value,phoneNumber.value); // Fetch data
      if (fetchedAccount) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
          ...
          <Text style={styles.Header}>Chào mừng đến với Smarthome</Text>      
      </View>
      <Text style={styles.text}>Để trống thông tin mà bạn không muốn thay đổi</Text>
